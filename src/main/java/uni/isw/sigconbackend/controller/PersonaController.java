...
public class PersonaController {
    ...
    @GetMapping("/searchByNDocumento/{ndocumento}")
    public ResponseEntity<List<Persona>> buscarPorNdocumento(@PathVariable String ndocumento) {
        return new ResponseEntity<>(personaService.findByNdocumento(ndocumento), HttpStatus.OK);        
    }
}
